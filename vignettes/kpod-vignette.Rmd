...
g1991means 
```
__Comment__: This example happen to demonstrate the inconsistencies in k-means clustering!
...
From the resulting line plots measuring the fit and ARI metrics of k-pod clustering compared to k-means clustering, we can conclude: k-POD is more consistent when data is larger, and when number of cluster is lower. k-POD performance is not easily affected by increasing the missingness within the data.
