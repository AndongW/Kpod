...
A related identity: <center> $totss = \sum withinss + betweenss$ </center>
...
### Performance comparison {.tabset .tabset-pills}
...
Data 1 is a relatively small data set. We will be looking at k-means performance with 0% missing; k-POD performance with 10% missing; k-POD performance with 20% missing; k-POD performance with 30% missing; k-POD performance with 40% missing; k-POD performance with 50% missing, demonstrated by the following scatter plots, colored by cluster group.  
...
#### Summary
does not demonstrate k-POD's quick execution time, detail see "k-POD: A Method for k-Means Clustering of Missing Data" by Jocelyn T. Chi, Eric C. Chi & Richard G. Baraniuk. 